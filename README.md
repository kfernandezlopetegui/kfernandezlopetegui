...
Electronics Technician & University-level Programmer (UTN) based in Buenos Aires, Argentina.
I teach Electronics at technical high schools and build projects that bridge hardware and software.

## 🔧 What I do
- 🖥️ **Web & App Development** — Python, PHP, C#, HTML/CSS
- ⚡ **Electronics & Hardware** — Arduino, microcontrollers, circuit repair
- 📊 **Data Analysis** — Currently exploring R and data science
- 🎓 **Teaching** — Making complex tech accessible to secondary school students
